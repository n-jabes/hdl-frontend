...
export default function ManageSensitiveAreasTable({ styles, tableData, headers }) {
        ...
        <table className="min-w-full text-xs text-gray-400 text-nowrap bg-gray-800 rounded-lg ">
          ...
          <tbody>
            {currentData.map((area, index) => (
              ...
              >
                <td className="px-4 py-2">{area.index}</td>
                <td className="px-4 py-2">{area.date}</td>
                <td className="px-4 py-2">{area.sectorLocation}</td>
                <td className="px-4 py-2">{area.siteName}</td>
                <td className="px-4 py-2">{area.coordinates}</td>
                <td className="px-4 py-2">{area.actions}</td>
              </tr>
            ))}
          </tbody>
        </table>
